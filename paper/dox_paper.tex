...
\begin{abstract}
Anthracycline-induced cardiotoxicity (ACT) is a key limiting factor in setting optimal chemotherapy regimes for cancer patients, with almost half of patients expected to develop congestive heart failure given high drug doses. 
However, the genetic basis of sensitivity to anthracyclines such as doxorubicin remains unclear. 
We created a panel of iPSC-derived cardiomyocytes from 45 individuals and performed RNA-seq after 24h exposure to varying levels of doxorubicin. 
The transcriptomic response to doxorubicin is substantial, with the majority of genes being differentially expressed across concentrations and over 6000 genes showing evidence of differential splicing. 
Moreover, we were able to detect 376 response-expression QTLs and 42 response-splicing QTLs, genetic variants that modulate the transcriptomic response to doxorubicin in terms of expression and splicing changes respectively. 
We show that inter-individual variation in transcriptional response is predictive of damage measured using cardiac troponin, and that this in turn is associated with \emph{in vivo} ACT risk. 
Finally, the molecular QTLs we detect are enriched in lower ACT GWAS $p$-values, further supporting the \emph{in vivo} relevance of our map of genetic regulation of cellular response to anthracyclines. 
\end{abstract}
...
The risk of CHF is dosage-dependent: the earliest study\cite{von1979risk} estimated 3\% of patients at 400 mg/m2, 7\% of patients at 550 mg/m2, and 18\% of patients at 700 mg/m2 develop CHF, where a more recent study puts these numbers at 5\%, 26\% and 48\% respectively\cite{Swain2003}. 
