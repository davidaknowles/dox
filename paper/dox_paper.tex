...
\noindent{\normalsize David A Knowles$^{1,2,3,*}$, Courtney K Burrows$^{4,*}$, John D Blischak$^{4}$, Kristen M Patterson$^{4}$, Carole Ober$^{4}$, Jonathan K Pritchard$^{1,5,6}$, Yoav Gilad$^{4,7}$\\
...
the iPSCs to cardiomyocytes by exposing iPSCs to \cite{todo} \cite{Lian2013, Burridge2014}. At day 20 we assayed purity by performing flow cytometry for cardiac Troponin T (antibody reference \cite{todo}) and replated cells from the same sample which had purity tested.
...
We gratefully acknowledge Bryan Schneider for providing GWAS summary statistics. This work was supported by the Howard Hughes Medical Institute, and the US National Institutes of Health (NIH grants HL092206, HG008140, HG009431). 
