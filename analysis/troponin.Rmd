...
joined %>% ggplot(aes(estimate, slopes, label=individual)) + geom_point(alpha=0.1) + geom_text() + xlab("Transcriptomic response") + ylab("Troponin response")
```
