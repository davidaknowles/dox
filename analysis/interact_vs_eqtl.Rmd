...
```{r}
res_dir="~/gdrive/dox_data/panama_qq_boot_1e+06/"
eqtl=foreach(fn=list.files(res_dir,glob2rx("chr*.txt.gz")), .combine = bind_rows) %do% {
  print(fn)
  fread(paste0(res_dir,fn), data.ta
}
