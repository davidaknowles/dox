...
samtools mpileup -B -d1000000 -l ~/scailscratch/Homo_sapiens/NCBI/GRCh38/snp147.txt -f ~/scailscratch/Homo_sapiens/NCBI/GRCh38/Sequence/Bowtie2Index/genome.fa $INFILEA $INFILEB  | ./pileup_filter 4 | gzip > $OUTFILE
